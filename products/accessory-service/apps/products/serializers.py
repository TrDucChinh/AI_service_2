...
class ReviewSerializer(serializers.ModelSerializer):
    class Meta:
        model = Review
        fields = ('id', 'product', 'user_id', 'user_name', 'rating', 'title', 'body', 'is_verified', 'is_approved', 'created_at')
...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ('id', 'name', 'brand', 'brand_name', 'category', 'category_name', 'sku', 'price', 'sale_price', 'current_price', 'is_on_sale', 'stock', 'is_active', 'primary_image', 'rating', 'created_at')
        read_only_fields = ('id', 'created_at')
...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ('id', 'name', 'brand', 'category', 'sku', 'description', 'price', 'sale_price', 'current_price', 'is_on_sale', 'stock', 'is_active', 'specifications', 'images', 'inventory', 'rating', 'reviews', 'created_at', 'updated_at')
...
class ProductWriteSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        fields = ('id', 'name', 'brand', 'category', 'sku', 'description', 'price', 'sale_price', 'stock', 'is_active', 'specifications')
        read_only_fields = ('id',)
