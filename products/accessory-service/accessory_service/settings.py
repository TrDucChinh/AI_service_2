...
SERVICE_NAME = 'accessory'
SERVICE_PORT = 8014
SECRET_KEY = config('DJANGO_SECRET_KEY', default='django-insecure-accessory-service-key')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='product_accessory'),
