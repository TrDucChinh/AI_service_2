...
class Review(models.Model):
    ...
    def __str__(self):
        return f"Review({self.product.name}, rating={self.rating})"
...
class Rating(models.Model):
    ...
    def __str__(self):
        return f"Rating({self.product.name}, avg={self.average_rating})"
    ...
    def update_for_product(cls, product):
        ...
        cls.objects.update_or_create(product=product, defaults={'average_rating': round(avg, 2), 'total_reviews': total})
