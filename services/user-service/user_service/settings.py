...
SECRET_KEY = config('DJANGO_SECRET_KEY', default='django-insecure-user-service-key')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('MYSQL_DB', default='ecommerce_users'),
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'apps.users.authentication.GatewayJWTAuthentication',
    ),
